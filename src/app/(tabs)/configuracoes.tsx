...
export default function Configuracoes() {
  ...
  titulo: { color: 'white', fontSize: 20, fontWeight: 'bold', marginBottom: 30 },
  fotoContainer: { alignItems: 'center', marginBottom: 25 },
  fotoPerfil: { width: 110, height: 110, borderRadius: 55, borderWidth: 4, borderColor: '#7ed957', backgroundColor: 'white', marginBottom: 10 },
  btnAlterarFoto: { borderWidth: 1, borderColor: '#7ed957', paddingVertical: 4, paddingHorizontal: 12, borderRadius: 20 },
  textoBtnFoto: { color: '#7ed957', fontSize: 11 },
  infoArea: { width: '100%', gap: 15, marginBottom: 30 },
  inputGroup: { width: '100%' },
  label: { color: 'white', fontSize: 13, fontWeight: 'bold', marginBottom: 5 },
  input: { width: '100%', padding: 12, borderRadius: 8, backgroundColor: '#d1d1d1', fontSize: 16, color: '#333' },
  actions: { width: '100%', gap: 10 },
  btnSenha: { backgroundColor: '#7ed957', padding: 12, borderRadius: 8, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 8 },
  textoBtnSenha: { fontWeight: 'bold', color: 'black' },
  btnSair: { backgroundColor: '#ff4b4b', padding: 12, borderRadius: 8, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 8 },
  textoBtnSair: { color: 'white', fontWeight: 'bold' },
  voltar: { color: 'white', marginTop: 20, textDecorationLine: 'underline', fontSize: 14 }
});
